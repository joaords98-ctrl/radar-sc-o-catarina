  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-5 sm:px-6 sm:py-8">
      <section className="rounded-2xl bg-zinc-950 p-5 text-white shadow-sm sm:rounded-3xl sm:p-8">
        <p className="text-xs font-bold uppercase tracking-[0.22em] text-zinc-400 sm:text-sm sm:tracking-[0.25em]">Radar SC v10</p>
        <h2 className="mt-3 text-2xl font-black leading-tight sm:text-4xl">Pautas por cidade com ordem do jeito que você quer.</h2>
        <p className="mt-4 max-w-4xl text-sm leading-6 text-zinc-300 sm:text-base">
          Filtre por cidade, região, tema e escolha se quer ver primeiro a notícia mais recente, a pauta com maior potencial, a maior concorrência ou o melhor potencial para Instagram.
        </p>
      </section>
