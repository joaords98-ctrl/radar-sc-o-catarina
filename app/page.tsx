  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-8">
      ...
      <section className="grid gap-4 md:grid-cols-4">
        ...
        <StatCard label="Última coleta" value={data.lastRun ? 'Rodou' : 'Sem coleta'} hint={data.lastRun?.created_at ? new Date(data.lastRun.created_at).toLocaleString('pt-BR') : 'Rode o cron manual'} />
      </section>
      ...
      <section className="mt-8 flex items-center justify-between">
        ...
        <a href="/api/cron/collect-news" className="rounded-xl bg-zinc-900 px-5 py-3 text-sm font-bold text-white">Atualizar agora</a>
      </section>
